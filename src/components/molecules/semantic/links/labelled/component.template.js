...
const codeSnippetCaseText = '<a href="#" aria-label="Accessible label">Visible label</a>'
...
const LabelledLinksSemanticMoleculeComponent = () => (
  <ElementVariantWrapperAtomComponent>
    ...
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledLinkSemanticAtomComponent id='labelledLinkSemantic' data-case='text' accessibleLabel='Accessible label' visibleLabel='Visible label' />
    </ElementVariantExampleWrapperAtomComponent>
    <ElementVariantCodeWrapperAtomComponent>{codeSnippetCaseText}</ElementVariantCodeWrapperAtomComponent>
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledLinkSemanticAtomComponent id='labelledLinkSemantic' data-case='emoji' accessibleLabel='Accessible label' visibleLabel='🔓' />
    </ElementVariantExampleWrapperAtomComponent>
