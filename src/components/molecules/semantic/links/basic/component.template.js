...
const BasicLinksSemanticMoleculeComponent = () => (
  <ElementVariantWrapperAtomComponent>
    ...
    <ElementVariantExampleWrapperAtomComponent>
      <BasicLinkSemanticAtomComponent id='basicLinkSemantic' data-case='text'>Visible label</BasicLinkSemanticAtomComponent>
    </ElementVariantExampleWrapperAtomComponent>
    <ElementVariantCodeWrapperAtomComponent>{codeSnippetCaseText}</ElementVariantCodeWrapperAtomComponent>
    <ElementVariantExampleWrapperAtomComponent>
      <BasicLinkSemanticAtomComponent id='basicLinkSemantic' data-case='emoji'>🔓</BasicLinkSemanticAtomComponent>
    </ElementVariantExampleWrapperAtomComponent>
