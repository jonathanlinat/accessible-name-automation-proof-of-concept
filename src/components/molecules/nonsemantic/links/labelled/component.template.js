...
const codeSnippetCaseText = '<span tabindex="0" aria-label="Accessible label">Visible label</span>'
const codeSnippetCaseEmoji = '<span tabindex="0" aria-label="Accessible label">🔓</span>'
...
const LabelledLinksNonSemanticMoleculeComponent = () => (
  <ElementVariantWrapperAtomComponent>
    ...
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledLinkNonSemanticAtomComponent id='labelledLinkNonSemantic' data-case='text' accessibleLabel='Accessible label' visibleLabel='Visible label' />
    </ElementVariantExampleWrapperAtomComponent>
    <ElementVariantCodeWrapperAtomComponent>{codeSnippetCaseText}</ElementVariantCodeWrapperAtomComponent>
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledLinkNonSemanticAtomComponent id='labelledLinkNonSemantic' data-case='emoji' accessibleLabel='Accessible label' visibleLabel='🔓' />
    </ElementVariantExampleWrapperAtomComponent>
