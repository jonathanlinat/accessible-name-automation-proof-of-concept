...
const codeSnippetCaseText = '<div tabindex="0" aria-label="Accessible label">Visible label</div>'
const codeSnippetCaseEmoji = '<div tabindex="0" aria-label="Accessible label">🔓</div>'
...
const LabelledButtonsNonSemanticMoleculeComponent = () => (
  <ElementVariantWrapperAtomComponent>
    ...
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledButtonNonSemanticAtomComponent id='labelledButtonNonSemantic' data-case='text' accessibleLabel='Accessible label' visibleLabel='Visible label' />
    </ElementVariantExampleWrapperAtomComponent>
    <ElementVariantCodeWrapperAtomComponent>{codeSnippetCaseText}</ElementVariantCodeWrapperAtomComponent>
    <ElementVariantExampleWrapperAtomComponent>
      <LabelledButtonNonSemanticAtomComponent id='labelledButtonNonSemantic' data-case='emoji' accessibleLabel='Accessible label' visibleLabel='🔓' variant='third' />
    </ElementVariantExampleWrapperAtomComponent>
