...
const FirstLevelTitlesNonSemanticMoleculeComponent = () => (
  <ElementVariantWrapperAtomComponent>
    <FourthLevelTitleSemanticAtomComponent>First level</FourthLevelTitleSemanticAtomComponent>
    <ElementVariantExampleWrapperAtomComponent>
      <FirstLevelTitleNonSemanticAtomComponent id='firstLevelTitleNonSemantic'>Visible title</FirstLevelTitleNonSemanticAtomComponent>
    </ElementVariantExampleWrapperAtomComponent>
